    ...
    */
    ...
    class Lv extends Logic {
        ...
        public function extend_lv($new_size) {
            ...
            $this->set_result('The logical volume ' . $this->lv_name . ' was successfully extended to ' . $new_size . 'gb', array('result' => 0, 'code_type' => 'intern'), true);
        ...
        public function reduce_lv($new_size) {
            ...
            $this->set_result('The logical volume ' . $this->lv_name . ' was successfully reduced to ' . $new_size . 'gb', array('result' => 0, 'code_type' => 'intern'), true);
        ...
        public function merge_snapshot() {
            ...
            $this->set_result('The snapshot ' . $this->lv_name . ' was successfully merged', array('result' => 0, 'code_type' => 'intern'), true);
            ...
            if ($this->is_snapshot() === true) {
                ...
                $this->set_result('The logical volume ' . $this->lv_name . ' is not a snapshot!', array('result' => 3, 'code_type' => 'intern'), true);
            }
        }
