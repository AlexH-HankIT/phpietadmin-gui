<?php
    class Parser extends Logging {
        ...
        /**
         *
         * Parse all informations from the ietd proc volume file
         *
        ...
        protected function parse_target(array $arg = []) {
            ...
            // parse all informations from ietd volume file
            ...
            // parse all informations from ietd session file
        ...
        /**
         *
         * Parse all informations from the ietd allow files
