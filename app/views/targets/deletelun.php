<div id='configure_target_body'>
    <div class="container">
        ...
        <div class='panel panel-default'>
            ...
            <div class='panel-body'>
                <div class="row">
                    <div class="col-md-12">
                        <select id="delete_lun_selector" class="form-control">
            ...
            <div class='panel-footer'>
                <div class="row">
                    <div class="col-md-12">
                        <button id="delete_lun_button" class="btn btn-danger" type="submit"><span class="glyphicon glyphicon-warning-sign" aria-hidden="true"></span> Delete</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        require(['common'], function () {
            require(['pages/target/delete_lun', 'domReady'], function (methods, domReady) {
                domReady(function () {
