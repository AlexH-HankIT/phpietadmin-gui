<div class="container">
	<ul class="nav nav-tabs">
		...
		<li class="configureTargetBodyMenu"><a href="/phpietadmin/targets/configure/<?php echo $data ?>#delete"><span class="glyphicon glyphicon-trash"></span><span class="hidden-xs"> Delete</span></a></li>
	</ul>
	<br />
</div>